...
# Remove covariates with high pairwise correlations
hcv <- findCorrelation(cor(train), cutoff=0.70)

# Recombine outcome variable
exclude <- unique(c(nzv,hcv,na))
train_clean <- data.frame(classe,train_clean[,-exclude])
